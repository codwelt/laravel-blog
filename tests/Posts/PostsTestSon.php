...
class PostsTestSon extends TestCaseSon
{
    ...
    public function storePost()
    {
       ...
       // $imageUpload = UploadedFile::fake();
        ...
        $response = $response->get(route(BlogServiceProvider::NAMESPACE_PROYECT . '.api.user.posts.show', ['slug' => $dataParameter["slug"]]),['Accept' => 'application/json']);
    ...
    public function searchAPIPost()
    {
        ...
        $url = route(BlogServiceProvider::NAMESPACE_PROYECT. ".api.user.posts.index",['query' => "prueba"]);
    ...
    public function getPostAPIJson()
    {
        ...
        $response = $this->get(route(BlogServiceProvider::NAMESPACE_PROYECT . '.api.user.posts.index', ['output' => 'ramdom']),['Accept' => 'application/json']);
